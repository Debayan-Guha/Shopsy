...
public class CustomerService {
    ...
    public String registerCustomer(Customer customer) {
        ...
        RolesEntity re = rr.getByuserroles(Roles.ROLE_CUSTOMER.toString());
    ...
    public String buyList(List<Order> order) {
        ...
        // created to store the each order contains order characteristics
        // like(Color,price,etc)
        ...
        for (Order or : order) {
            ...
            // finding each product by the product id . product id given by user during
            // buying
            ...
            // orderentity takes orderdetails list ->contains only inportantinfo about the
            // product buy
